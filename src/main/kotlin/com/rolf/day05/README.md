...
<p>Your puzzle answer was <code>236</code>.</p><article class="day-desc"><h2 id="part2">--- Part Two ---</h2><p>Realizing the error of his ways, Santa has switched to a better model of determining whether a string is naughty or nice.  None of the old rules apply, as they are all clearly ridiculous.</p>
...
<p>Your puzzle answer was <code>51</code>.</p>